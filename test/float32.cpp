...
int main(int argc, char** argv) {
	...
	test_float<std::plus<float>, std::plus<Float32>>(0.0);
	test_float<std::minus<float>, std::minus<Float32>>(0.0);
	test_float<std::multiplies<float>, std::multiplies<Float32>>(0.0);
	test_float<std::divides<float>, std::divides<Float32>>(0.0);
